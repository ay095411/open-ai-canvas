...
type FeatureKey = "shortDramaEnabled" | "taskCenterEnabled" | "creditsEnabled" | "frontendModelsEnabled" | "pluginCenterEnabled" | "galleryEnabled";
...
export function RequireFeature({ feature, children }: { feature: FeatureKey; children: ReactNode }) {
    ...
    const [checking, setChecking] = useState(() => !adminBypass && useUserStore.getState().features[feature] === false);
    ...
    if (!adminBypass && features[feature] === false) {
